...
// const findCompanyName = (array) => {
//     let result = array.map(item => item.company.name)
//     console.log(result);
// }
...
// const findEamil = (array) => {
//     let result = array.filter(item => item.email.endsWith(".biz")).map(item => item.email);
//     console.log(result);
// }
...
// const findTotalLength =(array) => {
//     let result = array.map(item => item.company.catchPhrase.length).reduce((sum, current) => sum + current, 0)
//     console.log(result);
// }
